...
export class EmailService {
  /**
   * Send Signup Verification OTP email (Awaited to prevent serverless function freeze)
   */
  ...
  /**
   * Send Password Reset OTP email (Awaited to prevent serverless function freeze)
   */
